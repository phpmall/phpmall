<template>
  <div class="login-switch">
    <a href="javascript:void(0);">
      <img
        src="@/assets/passport/img/switch-qrcode.png"
        v-on:click="showQrCode = !showQrCode"
        v-if="!showQrCode"
        alt=""
      />
      <img
        src="@/assets/passport/img/switch-mobile.png"
        v-on:click="showQrCode = !showQrCode"
        v-else
        alt=""
      />
  ...
  <div class="mobile-wrap" v-if="!showQrCode">
    <el-tabs v-model="activeName" class="login-tabs">
      <el-tab-pane label="帐号登录" name="default">
        ...
        >
          ...
          <el-form-item>
            <el-button type="primary" @click="submitForm(loginFormRef)" class="login-btn"
              >登 录</el-button
            >
          </el-form-item>
        </el-form>
    ...
    <div class="login-other">
      ...
      <span> | </span>
      <RouterLink :to="{ name: 'passport.forget' }">忘记密码？</RouterLink>
    </div>
  </div>

  <div class="qrcode-wrap" v-else>qrcode</div>
</template>

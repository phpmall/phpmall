...
import type {  } from '@/types/manager.d'
...
// [买家收货地址] 买家收货地址
export const userAddressService = (userId: number, page: number, pageSize: number): PromiseApp\Bundles\User\Responses\AddressResponse => {
    return request({

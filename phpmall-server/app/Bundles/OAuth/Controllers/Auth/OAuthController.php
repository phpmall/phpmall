...
{
    #[OA\Post(path: '/auth/oauth/redirect', summary: '获取授权跳转地址', tags: ['开放授权登录'])]
    ...
    #[OA\Post(path: '/auth/oauth/callback', summary: '授权登录回调地址', tags: ['开放授权登录'])]
    #[OA\Response(response: 200, description: 'OK')]
    ...
    #[OA\Post(path: '/auth/oauth/bind', summary: '新用户绑定接口', tags: ['开放授权登录'])]
    #[OA\Response(response: 200, description: 'OK')]

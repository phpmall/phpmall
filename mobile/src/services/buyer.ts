...
IProfileResponse,
IProfileRequest } from '@/types/buyer.d'
...
export const profileShowService = (): Promise<IProfileResponse> => {
    return request({
        url: 'buyer/profile/show',
        method: 'get'
    })
}

// [用户中心] 更新用户资料
export const profileUpdateService = (formData: IProfileRequest): Promise<any> => {
    return request({
        url: 'buyer/profile/update',
        method: 'put',
        data: formData
    })
}

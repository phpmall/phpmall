...
return new class extends Migration
{
    ...
    {
        Schema::create('order_back_order', function (Blueprint $table) {
            ...
            $table->string('zipcode')->nullable()->comment('邮政编码');
            ...
            $table->string('postscript')->nullable()->comment('订单附言');
            ...
            $table->unsignedInteger('update_time')->nullable()->default(0)->comment('更新时间');
            $table->integer('suppliers_id')->nullable()->default(0)->comment('供应商ID');
            $table->unsignedTinyInteger('status')->default(0)->comment('状态');
            $table->unsignedInteger('return_time')->nullable()->default(0)->comment('退货时间');
            $table->unsignedInteger('agency_id')->nullable()->default(0)->comment('办事处ID');
            $table->dateTime('created_time', 3)->useCurrent()->comment('创建时间');
            $table->dateTime('updated_time', 3)->useCurrentOnUpdate()->useCurrent()->comment('更新时间');
        });

        DB::statement("ALTER TABLE `order_back_order` COMMENT '退货订单表'");
    }
    ...
    {
        Schema::dropIfExists('order_back_order');
    }
};

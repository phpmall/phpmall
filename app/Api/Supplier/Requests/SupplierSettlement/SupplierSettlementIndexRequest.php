...
namespace App\Api\Supplier\Requests\SupplierSettlement;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'SupplierSupplierSettlementIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '结算状态', type: 'integer', nullable: true),
...
class SupplierSettlementIndexRequest extends FormRequest
{

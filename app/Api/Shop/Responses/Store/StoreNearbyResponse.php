...
#[OA\Schema(schema: 'ShopStoreNearbyResponse')]
class StoreNearbyResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '附近门店列表', type: 'array', items: new OA\Items(ref: StoreResponse::class))]
    private array $items;

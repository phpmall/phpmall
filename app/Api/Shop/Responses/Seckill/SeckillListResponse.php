...
namespace App\Api\Shop\Responses\Seckill;

use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ShopSeckillListResponse')]
class SeckillListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '秒杀活动列表', type: 'array', items: new OA\Items(ref: SeckillResponse::class))]
    private array $items;

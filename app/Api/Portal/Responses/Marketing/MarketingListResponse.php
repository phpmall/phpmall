...
#[OA\Schema(schema: 'PortalMarketingListResponse')]
class MarketingListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '营销活动列表', type: 'array', items: new OA\Items(ref: MarketingResponse::class))]
    private array $items;

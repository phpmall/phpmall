...
namespace App\Api\Portal\Responses\Category;

use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'PortalCategoryListResponse')]
class CategoryListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '分类列表', type: 'array', items: new OA\Items(ref: CategoryResponse::class))]
    private array $items;

...
namespace App\Api\Portal\Requests\Seckill;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'PortalSeckillIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '活动状态:0即将开始,1进行中,2已结束', type: 'integer', nullable: true),
...
class SeckillIndexRequest extends FormRequest
{

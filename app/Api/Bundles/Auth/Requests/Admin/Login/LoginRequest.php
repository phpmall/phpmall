...
namespace App\Bundles\Auth\Requests\Admin\Login;

use App\Foundation\Infra\Captcha\Rules\CaptchaRule;
...
#[OA\Schema(
    ...
    properties: [
        new OA\Property(property: 'username', description: '登录用户名', type: 'string', example: 'admin'),

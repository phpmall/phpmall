...
#[OA\Schema(schema: 'MemberLevelListResponse')]
class MemberLevelListResponse
{
    ...
    #[OA\Property(
        ...
        description: '会员等级列表',
        type: 'array',
        items: new OA\Items(ref: MemberLevelResponse::class)
    )]
    private array $items;
    ...
    public function setCurrentLevel(array $currentLevel): void
    {

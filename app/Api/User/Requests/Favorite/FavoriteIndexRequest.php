...
#[OA\Schema(
    schema: 'FavoriteIndexRequest',
    properties: [
        new OA\Property(property: self::getType, description: '收藏类型', type: 'integer', nullable: true),
...
class FavoriteIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getType.'.integer' => '收藏类型必须是整数',
            self::getType.'.min' => '收藏类型不能小于0',

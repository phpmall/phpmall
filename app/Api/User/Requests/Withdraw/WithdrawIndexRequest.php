...
namespace App\Api\User\Requests\Withdraw;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'WithdrawIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '提现状态', type: 'integer', nullable: true),

...
#[OA\Schema(
    schema: 'CouponIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '优惠券状态', type: 'integer', nullable: true),
...
class CouponIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '优惠券状态必须是整数',
            self::getStatus.'.min' => '优惠券状态不能小于0',

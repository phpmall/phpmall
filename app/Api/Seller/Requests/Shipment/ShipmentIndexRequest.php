...
#[OA\Schema(
    schema: 'SellerShipmentIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '发货单状态', type: 'integer', nullable: true),
...
class ShipmentIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '发货单状态必须是整数',
            self::getStatus.'.min' => '发货单状态不能小于0',

...
namespace App\Api\Seller\Requests\ProductAudit;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'SellerProductAuditIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '审核状态', type: 'integer', nullable: true),
...
class ProductAuditIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '审核状态必须是整数',
            self::getStatus.'.min' => '审核状态不能小于0',

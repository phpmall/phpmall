...
namespace App\Api\Seller\Requests\Waybill;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'SellerWaybillIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '运单状态', type: 'integer', nullable: true),
...
class WaybillIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '运单状态必须是整数',
            self::getStatus.'.min' => '运单状态不能小于0',

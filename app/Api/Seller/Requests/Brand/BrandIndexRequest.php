...
#[OA\Schema(
    schema: 'SellerBrandIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '品牌状态', type: 'integer', nullable: true),
...
class BrandIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '品牌状态必须是整数',
            self::getStatus.'.min' => '品牌状态不能小于0',

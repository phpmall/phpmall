...
namespace App\Api\Seller\Requests\SubOrder;

use Illuminate\Foundation\Http\FormRequest;
use OpenApi\Attributes as OA;

#[OA\Schema(
    schema: 'SellerSubOrderIndexRequest',
    properties: [
        new OA\Property(property: self::getStatus, description: '子订单状态', type: 'integer', nullable: true),
...
class SubOrderIndexRequest extends FormRequest
{
    ...
    {
        return [
            self::getStatus.'.integer' => '子订单状态必须是整数',
            self::getStatus.'.min' => '子订单状态不能小于0',

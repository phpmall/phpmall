...
#[OA\Schema(schema: 'SellerWalletTransactionListResponse')]
class WalletTransactionListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '交易记录列表', type: 'array', items: new OA\Items(ref: WalletTransactionResponse::class))]
    private array $items;

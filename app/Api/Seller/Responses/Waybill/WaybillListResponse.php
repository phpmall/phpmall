...
#[OA\Schema(schema: 'SellerWaybillListResponse')]
class WaybillListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '运单列表', type: 'array', items: new OA\Items(ref: WaybillResponse::class))]
    private array $items;

...
#[OA\Schema(schema: 'SellerWaybillPrintResponse')]
class WaybillPrintResponse
{
    ...
    #[OA\Property(property: 'print_url', description: '打印地址', type: 'string')]
    private string $printUrl;

    #[OA\Property(property: 'status', description: '运单状态', type: 'integer')]
    private int $status;

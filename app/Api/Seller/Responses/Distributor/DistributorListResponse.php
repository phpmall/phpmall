...
#[OA\Schema(schema: 'SellerDistributorListResponse')]
class DistributorListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '分销商列表', type: 'array', items: new OA\Items(ref: '#/components/schemas/SellerDistributorResponse'))]
    private array $items;

...
#[OA\Schema(schema: 'SellerSubOrderListResponse')]
class SubOrderListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '子订单列表', type: 'array', items: new OA\Items(ref: SubOrderResponse::class))]
    private array $items;

...
#[OA\Schema(schema: 'SellerContractListResponse')]
class ContractListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '合同列表', type: 'array', items: new OA\Items(ref: '#/components/schemas/SellerContractResponse'))]
    private array $items;

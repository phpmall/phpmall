...
#[OA\Schema(schema: 'SellerSeckillActivityListResponse')]
class SeckillActivityListResponse
{
    use HasSerializableAttributes;

    #[OA\Property(property: 'items', description: '秒杀活动列表', type: 'array', items: new OA\Items(ref: SeckillActivityResponse::class))]
    private array $items;

...
use App\Gateways\Passport\Services\Input\LoginViaMobileInput;
use App\Gateways\User\Enums\UserStatusEnum;
use App\Gateways\User\Services\UserService;
use App\Models\User;
...
class LoginService extends UserService
{
    ...
    public function mobile(LoginViaMobileInput $loginInput): User
    {
        ...
        if (! Hash::check($password, $user->getPassportPassword())) {

...
class PushServer
{
    ...
    public function onWorkerStart($worker): void
    {
        ...
        // Timer::add($this->webHookDelay, array($this, 'webHookCheck')); // webhook用来接收频道的一些事件
    }
    ...
    {
        // /ws/app/1234567890abcdefghig?protocol=7&client=js&version=3.2.4&flash=false
        if (! preg_match('/\/ws\/app\/([^\/^\?^ ]+)/', (string) $header, $match)) {

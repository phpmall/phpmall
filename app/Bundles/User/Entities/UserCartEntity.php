...
class UserCartEntity
{
    ...
    const string getSessionId = 'session_id'; // SessionID
    ...
    const string getRecType = 'rec_type'; // 记录类型

    const string getIsGift = 'is_gift'; // 是否赠品

    const string getIsShipping = 'is_shipping'; // 是否包邮

    const string getCanHandsel = 'can_handsel'; // 是否可以赠送
    ...
    #[OA\Property(property: 'sessionId', description: 'SessionID', type: 'string')]
    ...
    #[OA\Property(property: 'canHandsel', description: '是否可以赠送', type: 'integer')]

...
class UserRankEntity
{
    ...
    const string getRankName = 'rank_name'; // 等级名称

    const string getMinPoints = 'min_points'; // 最小积分

    const string getMaxPoints = 'max_points'; // 最大积分

    const string getDiscount = 'discount'; // 折扣

    const string getShowPrice = 'show_price'; // 是否显示价格

    const string getSpecialRank = 'special_rank'; // 是否特殊等级

...
class UserExtendFieldsEntity
{
    ...
    const string getRegFieldName = 'reg_field_name'; // 注册字段名称

    const string getDisOrder = 'dis_order'; // 显示顺序

    const string getDisplay = 'display'; // 是否显示

    const string getType = 'type'; // 类型

    const string getIsNeed = 'is_need'; // 是否必填

...
class LoginBundleService
{
     ...
     */
    public function login(LoginInput $loginInput): AdminUser
    {
     ...
     * 获取登录用户
     */
    private function user(string $username, AdminUserStatusEnum $status): ?AdminUser
    {
        $userService = new AdminUserBundleService();

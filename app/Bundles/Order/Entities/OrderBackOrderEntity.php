...
class OrderBackOrderEntity
{
    ...
    const string getDeliverySn = 'delivery_sn'; // 发货单号

    const string getOrderSn = 'order_sn'; // 订单编号

    const string getOrderId = 'order_id'; // 订单ID

    const string getInvoiceNo = 'invoice_no'; // 发票号
    ...
    const string getActionUser = 'action_user'; // 操作用户
    ...
    const string getUpdateTime = 'update_time'; // 更新时间

    const string getSuppliersId = 'suppliers_id'; // 供应商ID

    const string getStatus = 'status'; // 状态

    const string getReturnTime = 'return_time'; // 退货时间

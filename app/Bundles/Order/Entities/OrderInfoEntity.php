...
class OrderInfoEntity
{
    ...
    const string getOrderSn = 'order_sn'; // 订单编号

    const string getUserId = 'user_id'; // 用户ID

    const string getOrderStatus = 'order_status'; // 订单状态

    const string getShippingStatus = 'shipping_status'; // 配送状态

    const string getPayStatus = 'pay_status'; // 支付状态
    ...
    const string getZipcode = 'zipcode'; // 邮政编码
    ...
    const string getPostscript = 'postscript'; // 订单附言

    const string getShippingId = 'shipping_id'; // 配送方式ID

    const string getShippingName = 'shipping_name'; // 配送方式名称

    const string getPayId = 'pay_id'; // 支付方式ID

    const string getPayName = 'pay_name'; // 支付方式名称

    const string getHowOos = 'how_oos'; // 缺货处理方式

    const string getHowSurplus = 'how_surplus'; // 余额处理方式

    const string getPackName = 'pack_name'; // 包装名称

    const string getCardName = 'card_name'; // 贺卡名称

    const string getCardMessage = 'card_message'; // 贺卡内容

    const string getInvPayee = 'inv_payee'; // 发票抬头

    const string getInvContent = 'inv_content'; // 发票内容

    const string getGoodsAmount = 'goods_amount'; // 商品总金额

    const string getShippingFee = 'shipping_fee'; // 配送费用

    const string getInsureFee = 'insure_fee'; // 保价费用

    const string getPayFee = 'pay_fee'; // 支付费用

    const string getPackFee = 'pack_fee'; // 包装费用

    const string getCardFee = 'card_fee'; // 贺卡费用

    const string getMoneyPaid = 'money_paid'; // 已付款金额

    const string getSurplus = 'surplus'; // 余额

    const string getIntegral = 'integral'; // 使用积分

    const string getIntegralMoney = 'integral_money'; // 积分抵扣金额

    const string getBonus = 'bonus'; // 红包金额

    const string getOrderAmount = 'order_amount'; // 订单总金额

    const string getFromAd = 'from_ad'; // 来源广告ID

    const string getReferer = 'referer'; // 来源页面

    const string getAddTime = 'add_time'; // 添加时间

    const string getConfirmTime = 'confirm_time'; // 确认时间

    const string getPayTime = 'pay_time'; // 支付时间

    const string getShippingTime = 'shipping_time'; // 配送时间

    const string getPackId = 'pack_id'; // 包装ID

    const string getCardId = 'card_id'; // 贺卡ID

    const string getBonusId = 'bonus_id'; // 红包ID

    const string getInvoiceNo = 'invoice_no'; // 发货单号

    const string getExtensionCode = 'extension_code'; // 扩展代码

    const string getExtensionId = 'extension_id'; // 扩展ID

    const string getToBuyer = 'to_buyer'; // 给买家的留言

    const string getPayNote = 'pay_note'; // 付款备注

    const string getAgencyId = 'agency_id'; // 办事处ID

    const string getInvType = 'inv_type'; // 发票类型

    const string getTax = 'tax'; // 税额

    const string getIsSeparate = 'is_separate'; // 是否拆分

    const string getParentId = 'parent_id'; // 父订单ID

    const string getDiscount = 'discount'; // 折扣金额

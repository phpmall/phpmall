...
class OrderDeliveryOrderEntity
{
    ...
    const string getOrderSn = 'order_sn'; // 订单号

    const string getOrderId = 'order_id'; // 订单ID

    const string getInvoiceNo = 'invoice_no'; // 物流单号

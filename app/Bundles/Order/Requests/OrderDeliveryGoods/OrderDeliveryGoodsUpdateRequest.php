...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: self::getDeliveryId, description: '发货单ID', type: 'integer'),
        ...
        new OA\Property(property: self::getGoodsSn, description: '商品货号', type: 'string'),
...
class OrderDeliveryGoodsUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            self::getDeliveryId.'.required' => '请设置发货单ID',
            ...
            self::getGoodsSn.'.required' => '请设置商品货号',

...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: self::getInvoiceNo, description: '发票号', type: 'string'),
        ...
        new OA\Property(property: self::getUpdateTime, description: '更新时间', type: 'integer'),
        ...
        new OA\Property(property: self::getReturnTime, description: '退货时间', type: 'integer'),
        new OA\Property(property: self::getAgencyId, description: '办事处ID', type: 'integer'),
        new OA\Property(property: self::getCreatedTime, description: '创建时间', type: 'string'),
        new OA\Property(property: self::getUpdatedTime, description: '更新时间', type: 'string'),
    ]
)]
class OrderBackOrderUpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            self::getInvoiceNo.'.required' => '请设置发票号',
            ...
            self::getUpdateTime.'.required' => '请设置更新时间',
            self::getSuppliersId.'.required' => '请设置供应商ID',
            self::getStatus.'.required' => '请设置状态',
            self::getReturnTime.'.required' => '请设置退货时间',

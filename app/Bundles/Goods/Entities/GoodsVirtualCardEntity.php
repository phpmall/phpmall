...
class GoodsVirtualCardEntity
{
    ...
    const string getCardSn = 'card_sn'; // 卡号

    const string getCardPassword = 'card_password'; // 卡密

    const string getAddDate = 'add_date'; // 添加日期

    const string getEndDate = 'end_date'; // 结束日期

    const string getIsSaled = 'is_saled'; // 是否已售

    const string getOrderSn = 'order_sn'; // 订单号

    const string getCrc32 = 'crc32'; // CRC32校验

...
class GoodsEntity
{
    ...
    const string getCatId = 'cat_id'; // 商品分类ID

    const string getGoodsSn = 'goods_sn'; // 商品编码

    const string getGoodsName = 'goods_name'; // 商品名称

    const string getGoodsNameStyle = 'goods_name_style'; // 商品名称样式

    const string getClickCount = 'click_count'; // 点击次数

    const string getBrandId = 'brand_id'; // 商品品牌ID

    const string getProviderName = 'provider_name'; // 供应商名称

    const string getGoodsNumber = 'goods_number'; // 商品库存

    const string getGoodsWeight = 'goods_weight'; // 商品重量

    const string getMarketPrice = 'market_price'; // 市场价格

    const string getShopPrice = 'shop_price'; // 商城价格

    const string getPromotePrice = 'promote_price'; // 促销价格

    const string getPromoteStartDate = 'promote_start_date'; // 促销开始时间

    const string getPromoteEndDate = 'promote_end_date'; // 促销结束时间

    const string getWarnNumber = 'warn_number'; // 库存警告数量

    const string getKeywords = 'keywords'; // 关键词

    const string getGoodsBrief = 'goods_brief'; // 商品简介

    const string getGoodsDesc = 'goods_desc'; // 商品描述

    const string getGoodsThumb = 'goods_thumb'; // 商品缩略图

    const string getGoodsImg = 'goods_img'; // 商品图片

    const string getOriginalImg = 'original_img'; // 商品原图

    const string getIsReal = 'is_real'; // 是否实物

    const string getExtensionCode = 'extension_code'; // 扩展代码

    const string getIsOnSale = 'is_on_sale'; // 是否上架

    const string getIsAloneSale = 'is_alone_sale'; // 是否单独销售

    const string getIsShipping = 'is_shipping'; // 是否包邮

    const string getIntegral = 'integral'; // 积分

    const string getAddTime = 'add_time'; // 添加时间

    const string getSortOrder = 'sort_order'; // 排序

    const string getIsDelete = 'is_delete'; // 是否删除

    const string getIsBest = 'is_best'; // 是否精品

    const string getIsNew = 'is_new'; // 是否新品

    const string getIsHot = 'is_hot'; // 是否热卖

    const string getIsPromote = 'is_promote'; // 是否促销

    const string getBonusTypeId = 'bonus_type_id'; // 红包类型ID

    const string getLastUpdate = 'last_update'; // 最后更新时间

    const string getGoodsType = 'goods_type'; // 商品类型

    const string getSellerNote = 'seller_note'; // 商家备注

    const string getGiveIntegral = 'give_integral'; // 赠送积分

    const string getRankIntegral = 'rank_integral'; // 等级积分

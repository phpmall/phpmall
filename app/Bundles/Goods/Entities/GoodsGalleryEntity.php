...
class GoodsGalleryEntity
{
    ...
    const string getImgUrl = 'img_url'; // 图片URL

    const string getImgDesc = 'img_desc'; // 图片描述

    const string getThumbUrl = 'thumb_url'; // 缩略图URL

    const string getImgOriginal = 'img_original'; // 原始图片

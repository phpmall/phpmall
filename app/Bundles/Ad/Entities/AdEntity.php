...
class AdEntity
{
    ...
    const string getPositionId = 'position_id'; // 广告位置ID

    const string getMediaType = 'media_type'; // 媒体类型

    const string getAdName = 'ad_name'; // 广告名称

    const string getAdLink = 'ad_link'; // 广告链接

    const string getAdCode = 'ad_code'; // 广告代码
    ...
    const string getLinkEmail = 'link_email'; // 联系邮箱

    const string getLinkPhone = 'link_phone'; // 联系电话

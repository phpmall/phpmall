...
namespace App\Bundles\Article\Entities;
...
class ArticleEntity
{
    ...
    const string getAuthor = 'author'; // 作者

    const string getAuthorEmail = 'author_email'; // 作者邮箱

    const string getKeywords = 'keywords'; // 关键词

    const string getArticleType = 'article_type'; // 文章类型

    const string getIsOpen = 'is_open'; // 是否公开

    const string getAddTime = 'add_time'; // 添加时间

    const string getFileUrl = 'file_url'; // 文件地址

    const string getOpenType = 'open_type'; // 打开方式

    const string getLink = 'link'; // 链接地址

    const string getDescription = 'description'; // 文章描述

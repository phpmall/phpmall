...
namespace App\Bundles\Template\Entities;
...
class TemplateEntity
{
    ...
    const string getFilename = 'filename'; // 文件名

    const string getRegion = 'region'; // 区域

    const string getLibrary = 'library'; // 库

    const string getSortOrder = 'sort_order'; // 排序顺序

    const string getIdValue = 'id_value'; // 关联ID

    const string getNumber = 'number'; // 数量

    const string getType = 'type'; // 类型

    const string getTheme = 'theme'; // 主题

    const string getRemarks = 'remarks'; // 备注

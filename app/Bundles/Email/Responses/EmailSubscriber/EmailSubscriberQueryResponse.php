...
namespace App\Bundles\Email\Responses\EmailSubscriber;

use Juling\Foundation\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\DTOHelper;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'EmailSubscriberQueryResponse')]
class EmailSubscriberQueryResponse
{
    use DTOHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: EmailSubscriberResponse::class))]
    private array $data;

...
class ShopNavEntity
{
    ...
    const string getCtype = 'ctype'; // 类别类型

    const string getCid = 'cid'; // 类别ID

    const string getName = 'name'; // 导航名称

    const string getIfshow = 'ifshow'; // 是否显示

    const string getVieworder = 'vieworder'; // 显示顺序

    const string getOpennew = 'opennew'; // 是否新窗口打开

    const string getUrl = 'url'; // URL地址

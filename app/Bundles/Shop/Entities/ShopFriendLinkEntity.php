...
class ShopFriendLinkEntity
{
    ...
    const string getLinkName = 'link_name'; // 链接名称

    const string getLinkUrl = 'link_url'; // 链接地址

    const string getLinkLogo = 'link_logo'; // 链接Logo

    const string getShowOrder = 'show_order'; // 排序

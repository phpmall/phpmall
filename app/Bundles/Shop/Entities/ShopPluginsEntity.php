...
class ShopPluginsEntity
{
    ...
    const string getCode = 'code'; // 插件编码

    const string getVersion = 'version'; // 版本号

    const string getLibrary = 'library'; // 库名

    const string getAssign = 'assign'; // 分配状态

    const string getInstallDate = 'install_date'; // 安装日期

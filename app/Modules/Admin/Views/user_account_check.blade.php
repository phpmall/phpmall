...
<div class="main-div">
    <form method="post" action="user_account.php" name="theForm" onsubmit="return validate();">
        <table border="0" width="100%">
            <tr>
                <td colspan="2"><strong>{{ $lang['surplus_info'] }}：</strong>
                    <hr/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <strong>{{ $lang['user_id'] }}：</strong>{{ $user_name }}
                    &nbsp;&nbsp;<strong>{{ $lang['surplus_amount'] }}：</strong>{{ $surplus['amount'] }}
                    &nbsp;&nbsp;<strong>{{ $lang['add_date'] }}：</strong>{{ $surplus['add_time'] }}
            ...
            <tr>
                <td colspan="2"><strong>{{ $lang['surplus_desc'] }}：</strong>{{ $surplus['user_note'] }}
                    <hr/>
                </td>
            </tr>
            <tr>

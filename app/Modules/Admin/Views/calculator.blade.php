...
<head>
    ...
    <script type="text/javascript">
        ...
        Calculator.output = function () {
            return document.getElementById('calculatorOutput');
        }
...
<div class="buttonArea">
    ...
    <table width="100%">
        <tr>
            <td colspan="2"><input type="button" class="calculatorButton2" value="{{ $lang['clear_calculator'] }}"
                                   onclick="Calculator.clear()"/></td>
            <td colspan="2"><input type="button" class="calculatorButton2" value="{{ $lang['backspace'] }}"
                                   onclick="Calculator.backspace()"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="38">&nbsp;</td>
            <td colspan="2">
                <div align="center"><a href="#" onclick="top.close()">{{ $lang['close_window'] }}</a></div>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>

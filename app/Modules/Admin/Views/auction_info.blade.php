    ...
    <form method="post" action="auction.php" name="theForm" enctype="multipart/form-data" onSubmit="return validate()">
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td><textarea name="act_desc" cols="60" rows="4" id="act_desc">{{ $auction['act_desc'] }}</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input name="start_time" type="text" id="start_time" value="{{ $auction['start_time'] }}"
                           readonly="readonly"/>
            ...
            <tr>
                ...
                <td><input name="end_time" type="text" id="end_time" value="{{ $auction['end_time'] }}"
                           readonly="readonly"/>
            ...
            <tr>
                ...
                <td><input name="end_price" type="text" id="end_price" '.($auction['no_top'] ? 'disabled="true" ' :
                    'value="{{ $auction['end_price'] }}"').'><input name="no_top" type="checkbox" value="1"
                                                                    onClick="checked_no_top(this);"
                                                                    onChange="checked_no_top(this);"
                                                                    @if($auction['no_top'])checked@endif/>{{ $lang['label_no_top'] }}
                </td>
            </tr>
            <tr>
            ...
            @if($auction['act_id'] > 0)
                <tr>
                    ...
                    <td>{{ $auction['status'] }}<br/>{{ $bid_user_count }} <a
                            href="auction.php?act=view_log&id={{ $auction['act_id'] }}"> [ {{ $lang['view'] }} ]</a>
                    </td>
                </tr>
            @endif
            <tr>

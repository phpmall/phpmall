    ...
    <form action="ads.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
        <table width="100%" id="general-table">
                ...
                <td class="label">
                    <a href="javascript:showNotice('NameNotic');" title="{{ $lang['form_notice'] }}">
                        <img src="{{ asset('static/admin/images/notice.gif') }}" width="16" height="16" border="0"
                             alt="{{ $lang['form_notice'] }}"></a>{{ $lang['ad_name'] }}</td>
                <td>
                    <input type="text" name="ad_name" value="{{ $ads['ad_name'] }}" size="35"/>
                    <br/><span class="notice-span"
                               {{ $help_open ? 'style="display:block" ' : ' style="display:none" ' }} id="NameNotic">{{ $lang['ad_name_notic'] }}</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input name="start_time" type="text" id="start_time" size="22" value='{{ $ads['start_time'] }}'
            ...
            <tr>
                ...
                <td>
                    <input name="end_time" type="text" id="end_time" size="22" value='{{ $ads['end_time'] }}'
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('AdCodeImg');" title="{{ $lang['form_notice'] }}">
                            <img src="{{ asset('static/admin/images/notice.gif') }}" width="16" height="16" border="0"
                                 alt="{{ $lang['form_notice'] }}"></a>{{ $lang['upfile_img'] }}</td>
                    <td>
                        <input type='file' name='ad_img' size='35'/>
                        <br/><span class="notice-span"
                                   {{ $help_open ? 'style="display:block" ' : ' style="display:none" ' }} id="AdCodeImg">{{ $lang['ad_code_img'] }}</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="label">
                        <a href="javascript:showNotice('AdCodeFlash');" title="{{ $lang['form_notice'] }}">
                            <img src="{{ asset('static/admin/images/notice.gif') }}" width="16" height="16" border="0"
                                 alt="{{ $lang['form_notice'] }}"></a>{{ $lang['upfile_flash'] }}</td>
                    <td>
                        <input type='file' name='upfile_flash' size='35'/>
                        <br/><span class="notice-span"
                                   {{ $help_open ? 'style="display:block" ' : ' style="display:none" ' }} id="AdCodeFlash">{{ $lang['ad_code_flash'] }}</span>
                    </td>
                </tr>
                <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="enabled" value="1"
                           @if($ads['enabled'] === 1) checked="true" @endif />{{ $lang['is_enabled'] }}
                    <input type="radio" name="enabled" value="0"
                           @if($ads['enabled'] === 0) checked="true" @endif />{{ $lang['no_enabled'] }}
                </td>
            </tr>
            <tr>

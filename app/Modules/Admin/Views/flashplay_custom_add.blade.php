    ...
    <form action="flashplay.php" method="post" name="theForm" enctype="multipart/form-data"
        ...
        <table width="100%" id="general-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ad[ad_name]" id="ad_name" value="{{ $ad['ad_name'] }}" size="35"/><span
                ...
                <td class="label">
                    <a href="javascript:showNotice('title_upload');" title="{{ $lang['form_notice'] }}">
                        <img src="{{ asset('static/admin/images/notice.gif') }}" width="16" height="16" border="0"
                             alt="{{ $lang['form_notice'] }}"></a>{{ $lang['lable_upload'] }}</td>
                <td>
            ...
            <tr>
                <td class="label">&nbsp;</td>
                <td><input type="text" name="content[img_url]" id="img_url" value="{{ $ad['content'] }}" size="35"
            ...
            <tr>
                ...
                <td><input type="radio" name="ad[ad_status]" id="ad_status" value="0"
                           @if($ad['ad_status'] === 0)checked="checked"@endif>关闭
                    <input type="radio" name="ad[ad_status]" id="ad_status" value="1"
                           @if($ad['ad_status'] === 1)checked="checked"@endif>启用
                </td>
            </tr>
            <tr>
                <td class="label">&nbsp;</td>

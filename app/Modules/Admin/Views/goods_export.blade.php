    ...
    <tr>
        <td>
            <div class="main-div" style="background-color: white;">
                {{ $lang['user_guide'] }}
                <h3>
                    <center>{{ $lang['export_condition'] }}</center>
                </h3>
                <div>
                    <form action="goods_export.php" method="post" name="searchForm" onsubmit="return queryGoods(this)">
                        ...
                        <!-- 分类 -->
                        <select name="cat_id">
                            <option value="0">{{ $lang['custom_goods_cat'] }}</option>{{ $cat_list }}
                        </select>
                        <!-- 品牌 -->
                        <select name="brand_id">
                            <option value="0">{{ $lang['custom_goods_brand'] }}</option>
                        ...
                        <input type="submit" name="search_submit" id="search_submit"
                               value="{{ $lang['export_condition_search'] }}" class="button"/>
                    </form>
                </div>
                <table>
                    <tr>
                        ...
                        <td width="46%"><select name="dst_goods_lists" id="dst_goods_lists" size="14" style="width:100%"
                                                multiple="true">
                            </select></td>
                    </tr>
                </table>
...
<div id="phpmall_form" style="display:none">
        ...
        <table width="100%">
            ...
            <tr>
                <td>
                    ...
                    <input type="hidden" name="act" value="act_export_phpmall">
                </td>
                <td>
                    <input name="submit" type="submit" id="submit" value="{{ $lang['button_submit'] }}"
                           class="button"/>
                </td>
            </tr>
        </table>
    ...
    <form action="goods_export.php" method="post" name="theForm1" onsubmit="return formValidate1()">
        <table width="100%">
            ...
            <tr>
                ...
                <td><input type="text" name="express" value="0"/>
            </tr>
            <tr>
            <tr>
                <td class="label">{{ $lang['ems'] }}</td>
                <td><input type="text" name="ems" value="0"/>
            </tr>
            <tr>
            <tr>
                <td>&nbsp; <input name="cat_id" type="hidden" value=""/>
                    <input name="brand_id" type="hidden" value=""/>
                    <input name="keyword" type="hidden" value=""/>
                    <input name="goods_ids" type="hidden" value=""/><input type="hidden" name="act"
                                                                           value="act_export_taobao">
                </td>
                <td><input name="submit" type="submit" id="submit" value="{{ $lang['button_submit'] }}"
                           class="button"/>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <div class="main-div" style="background-color: white;">
                        <table>
                            <tr>
                                <td width="45%"><strong>{{ $lang['custom_goods_list'] }}</strong><span
                                        style="margin-left:20px;"><select name="goods_type" id="goods_type">
                                            <option value="0">{{ $lang['custom_goods_type'] }}</option>
                                            {{ $goods_type_list }}
                                        </select></span>
                                </td>
                                ...
                                <td rowspan="2" width="5%" style="text-align:center;">
                                    <p><input type="button" value="{{ $lang['custom_up'] }}" id="mvUp" class="button"/>
                                    </p>
                                    <p><input type="button" value="{{ $lang['custom_down'] }}" id="mvDown"
                                              class="button"/></p>
                                </td>
                            </tr>
                            <tr>
                                <td><select name="src_goods_fields" id="src_goods_fields" size="14" style="width:100%"
                                            multiple="true">{html_options options=$goods_fields}
                                    </select></td>
                                <td><select name="dst_goods_fields" id="dst_goods_fields" size="14" style="width:100%"
                                            multiple="true">
                                    </select></td>
                            </tr>
                            <tr>

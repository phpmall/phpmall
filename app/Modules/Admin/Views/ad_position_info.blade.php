...
<div class="main-div">
    <form action="ad_position.php" method="post" name="theForm" enctype="multipart/form-data"
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td><input type="text" name="ad_width" value="{{ $posit_arr['ad_width'] }}" size="30"/>
                    {{ $lang['unit_px'] }}</td>
            </tr>
            <tr>
                <td class="label">{{ $lang['ad_height'] }}</td>
                <td>
                    <input type="text" name="ad_height" value="{{ $posit_arr['ad_height'] }}" size="30"/>
                    {{ $lang['unit_px'] }}
                </td>
            </tr>
            <tr>

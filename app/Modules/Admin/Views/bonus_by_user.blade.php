...
<div class="main-div">
    <form name="theForm" action="bonus.php" method="post" onsubmit="return validate();">
        <div class="form-div">
            <img src="{{ asset('static/admin/images/icon_search.gif') }}" border="0"
                 alt="SEARCH"/>{{ $lang['keywords'] }}
            ...
            <table cellspacing='1' cellpadding='3'>
                ...
                <tr>
                    <td width="45%" align="center">
                        <select name="user_search[]" id="user_search" size="15" style="width:260px"
                    ...
                    <td width="45%" align="center">
                        <select name="user[]" id="user" multiple="true" size="15" style="width:260px"
                                ondblclick="delUser()">
                        </select>
                    </td>
                </tr>
                <tr>
                    <td align="center" colspan="3"><input type="submit" name="send_user"
                                                          value="{{ $lang['confirm_send_bonus'] }}" class="button"/>
                    </td>
                </tr>
            </table>
        </div>

...
<div class="form-div">
    <table width="98%">
        ...
        <tr>
            <td>{{ $lang['amount'] }}:{{ $repay['amount'] }}&nbsp;&nbsp;&lt;{{ $lang['user_money'] }}
                :{{ $repay['user_money'] }}&gt;
            </td>
            <td align="right">{{ $repay['apply_time'] }}</td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    @if($repay['is_repayed'])
        <ul>
            <li>{{ $repay['action_user'] }}{{ $lang['from'] }}{{ $repay['action_time'] }}{{ $lang['reply'] }}:
                <p>{{ $repay['action_note'] }}</p>
            </li>
        </ul>
    @endif
</div>
    ...
    <form method="post" action="repay.php?act=action" name="theForm" onsubmit="return validate()">
        <table border="0" width="98%">
            ...
            <tr>
                ...
                <td rowspan="2"><textarea name="action_note" cols="50" rows="2" wrap="VIRTUAL"
                                          id="msg_content">{{ $repay['action_note'] }}</textarea></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                        ...
                        <input name="dispose" value="{{ $lang['button_dipose'] }}" type="submit" class="button">&nbsp;
                        &nbsp;&nbsp;<input name="skip" value="{{ $lang['button_skip'] }}" type="submit" class="button">
                    @endif
                </td>
            </tr>
            <tr>

...
<body>
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;"><img src="{{ asset('static/admin/images/phpmall_logo.gif') }}"
                                                     alt="PHPMall - power for e-commerce"/></div>
    ...
    <div id="submenu-div">
        <ul>
            ...
            <li><a
                    href="javascript:window.top.frames['main-frame'].document.location.reload();window.top.frames['header-frame'].document.location.reload()">{{ $lang['refresh'] }}</a>
            </li>
            <li style="border-left:none;"><a href="#" onclick="ShowToDoList()">{{ $lang['todolist'] }}</a></li>
        </ul>
        <div id="send_info"
             style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;">
            @if ($send_mail_on === 'on')
                <span id="send_msg"><img src="{{ asset('static/admin/images/top_loader.gif') }}" width="16" height="16"
                                         alt="{{ $lang['loading'] }}" style="vertical-align: middle"/>
                        {{ $lang['email_sending'] }}</span>
                <a href="javascript:;" onClick="Javascript:switcher()" id="lnkSwitch"
                   style="margin-right:10px;color: #FF9900;text-decoration: underline">{{ $lang['pause'] }}</a>
            @endif
            <a href="index.php?act=clear_cache" target="main-frame"
               class="fix-submenu">{{ $lang['clear_cache'] }}</a>
        ...
        @endif
        <div id="load-div"
             style="padding: 5px 10px 0 0; text-align: right; color: #FF9900; display: none;width:40%;float:right;">
            <img src="{{ asset('static/admin/images/top_loader.gif') }}" width="16" height="16"
                 alt="{{ $lang['loading'] }}" style="vertical-align: middle"/> {{ $lang['loading'] }}</div>
    </div>
</div>
<div id="menu-div">
    <ul>

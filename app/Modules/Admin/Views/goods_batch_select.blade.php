    ...
    <form name="theForm" method="post" action="goods_batch.php?act=edit" onsubmit="return getGoodsIDs()">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td>
                    <label><input name="select_method" id="sm_cat" type="radio" value="cat" checked
                                  onclick="toggleSelectMethod(this.value)">{{ $lang['by_cat'] }}</label>
                    <label><input name="select_method" id="sm_sn" type="radio" value="sn"
                                  onclick="toggleSelectMethod(this.value)">{{ $lang['by_sn'] }}</label>
                </td>
            </tr>
            <tr id="cat_1">
            ...
            <tr id="cat_4">
                ...
                <td valign="middle" id="cat_6">
                    <table border="0" cellspacing="1" cellpadding="3">
                        ...
                        <tr>
                            <td width="45%">
                                <select name="srcList" size="10" multiple id="srcList" style="width: 100%"
                                        ondblclick="addGoods()"></select>
                            </td>
                            <td align="center" valign="middle"><input name="add" type="button" class="button" id="add"
                                                                      value="&gt;&gt;" onclick="addGoods()"/><br/>
                                <input name="del" class="button" type="button" id="del" value="&lt;&lt;"
                                       onclick="delGoods()"/>
                            </td>
                            <td width="45%">
                                <select name="destList" size="10" multiple id="destList" style="width: 100%"
                                        ondblclick="delGoods()"></select>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr style="display:none" id="sn_1">
                ...
                <td style="display:none" id="sn_3"><textarea name="sn_list" rows="10" cols="40" id="sn_list"></textarea>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="edit_method" value="all">{{ $lang['edit_all'] }}</label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>

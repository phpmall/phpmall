            ...
            <tr>
                ...
                <td>
                    <table width="100%" border="0">
                        <tr>
                            <td width="46%"><select name="src_goods_lists" id="src_goods_lists" size="14"
                            ...
                            <td width="46%"><select name="dst_goods_lists" id="dst_goods_lists" size="14"
                                                    style="width:100%" multiple="true"></select></td>
                        </tr>
                    </table>
                </td>
            </tr>

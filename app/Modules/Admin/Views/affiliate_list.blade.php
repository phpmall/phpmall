            ...
            <table cellpadding="3" cellspacing="1">
                ...
                @forelse($user_list as $user)
                    <tr>
                        ...
                        <td align="center">@if($user['is_validated'])
                        ...
                        <td align="center">
                            ...
                            <a href="users.php?act=address_list&id={{ $user['user_id'] }}"
                               title="{{ $lang['address_list'] }}"><img
                                    src="{{ asset('static/admin/images/book_open.gif') }}" border="0" height="16"
                                    width="16"/></a>
                            ...
                            <a href="account_log.php?act=list&user_id={{ $user['user_id'] }}"
                               title="{{ $lang['view_deposit'] }}"><img
                                    ...
                                    width="16"/></a>
                            <a href="javascript:confirm_redirect('{{ $lang['remove_confirm'] }}', 'users.php?act=remove&id={{ $user['user_id'] }}')"

        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td><select name="add_sub_frozen_money" id="add_sub_frozen_money">
                    ...
                    <input name="frozen_money" type="text" id="frozen_money" style="text-align:right" value="0"
                           size="10"/>
            ...
            <tr>
                ...
                <td><select name="add_sub_rank_points" id="add_sub_rank_points">
                    ...
                    <input name="rank_points" type="text" id="rank_points" style="text-align:right" value="0"
                           size="10"/>

    ...
    <div class="list-div" style="border: 1px solid #CC0000">
        <table cellspacing='1' cellpadding='3'>
            ...
            @foreach($admin_msg as $msg)
                <tr align="center">
                    <td align="left"><a
                            href="message.php?act=view&id={{ $msg['message_id'] }}">{{ str_limit($msg['title'], 60, '...') }}</a>
                    </td>
                    <td>{{ $msg['user_name'] }}</td>
                    <td>{{ $msg['send_date'] }}</td>
                </tr>
...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        ...
        <tr>
            <td width="20%"><a
                    href="order.php?act=list&composite_status={{ $status['await_ship'] }}">{{ $lang['await_ship'] }}</a>
            </td>
            <td width="30%"><strong style="color: red">{{ $order['await_ship'] }}</strong></td>
            <td width="20%"><a
                    href="order.php?act=list&composite_status={{ $status['unconfirmed'] }}">{{ $lang['unconfirmed'] }}</a>
            </td>
            <td width="30%"><strong>{{ $order['unconfirmed'] }}</strong></td>
        </tr>
        <tr>
            <td><a href="order.php?act=list&composite_status={{ $status['await_pay'] }}">{{ $lang['await_pay'] }}</a>
            </td>
        ...
        <tr>
            <td>
                <a href="order.php?act=list&composite_status={{ $status['shipped_part'] }}">{{ $lang['shipped_part'] }}</a>
            </td>
...
<div class="list-div">
    <table cellspacing='1' cellpadding='3'>
        ...
        <tr>
            ...
            <td width="20%"><a
                    href="goods.php?act=list&amp;stock_warning=1&amp;extension_code=virtual_card">{{ $lang['warn_goods'] }}</a>
            </td>
            <td width="30%"><strong style="color: red">{{ $virtual_card['warn'] }}</strong></td>
        </tr>
        <tr>
            <td>
                <a href="goods.php?act=list&amp;intro_type=is_new&amp;extension_code=virtual_card">{{ $lang['new_goods'] }}</a>
            </td>
            <td><strong>{{ $virtual_card['new'] }}</strong></td>
            <td>
                <a href="goods.php?act=list&amp;intro_type=is_best&amp;extension_code=virtual_card">{{ $lang['recommed_goods'] }}</a>
            </td>
            <td><strong>{{ $virtual_card['best'] }}</strong></td>
        </tr>
        <tr>
            <td>
                <a href="goods.php?act=list&amp;intro_type=is_hot&amp;extension_code=virtual_card">{{ $lang['hot_goods'] }}</a>
            </td>
            <td><strong>{{ $virtual_card['hot'] }}</strong></td>
            <td>
                <a href="goods.php?act=list&amp;intro_type=is_promote&amp;extension_code=virtual_card">{{ $lang['sales_count'] }}</a>
            </td>

...
<div class="main-div">
    <form action="goods_batch.php?act=upload" method="post" enctype="multipart/form-data" name="theForm"
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                <td class="label">
                    <a href="javascript:showNotice('noticeFile');" title="{{ $lang['form_notice'] }}"><img
                ...
                <td><input name="file" type="file" size="40">
                    ...
                    id="noticeFile">{{ $lang['notice_file'] }}</span>
                </td>
            </tr>
            @foreach($download_list as $download => $charset)
                <tr>
                    <td>&nbsp;</td>
            ...
            @endforeach
            <tr align="center">
                <td colspan="2"><input name="submit" type="submit" id="submit" value="{{ $lang['button_submit'] }}"
                                       class="button"/></td>
            </tr>
        </table>
    </form>

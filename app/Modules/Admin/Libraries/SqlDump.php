...
class SqlDump
{
     ...
     * @param  bool  $add_drop  是否加入drop table
     * @return string $sql
     */
    ...
    public function dump_table($path, $vol)
    {
        ...
        $this->dump_sql .= '-- END phpmall v2.x SQL Dump Program ';

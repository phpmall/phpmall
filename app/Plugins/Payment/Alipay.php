...
$payment_lang = ROOT_PATH.'languages/'.cfg('lang').'/payment/alipay.php';
...
class Alipay
{
    ...
    public function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><input type="button" onclick="window.open(\'https://mapi.alipay.com/gateway.do?'.$param.'&sign='.md5($sign).'&sign_type=MD5\')" value="'.lang('pay_button').'" /></div>';

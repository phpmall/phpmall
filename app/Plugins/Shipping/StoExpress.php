...
$shipping_lang = ROOT_PATH.'languages/'.cfg('lang').'/shipping/sto_express.php';
...
if (isset($set_modules) && $set_modules === true) {
    ...
    // 打印快递单标签位置信息
    $modules[$i]['config_lable'] = 't_shop_address,'.lang('lable_box.shop_address').',235,48,131,152,b_shop_address||,||t_shop_name,'.lang('lable_box.shop_name').',237,26,131,200,b_shop_name||,||t_shop_tel,'.lang('lable_box.shop_tel').',96,36,144,257,b_shop_tel||,||t_customer_post,'.lang('lable_box.customer_post').',86,23,578,268,b_customer_post||,||t_customer_address,'.lang('lable_box.customer_address').',232,49,434,149,b_customer_address||,||t_customer_name,'.lang('lable_box.customer_name').',151,27,449,231,b_customer_name||,||t_customer_tel,'.lang('lable_box.customer_tel').',90,32,452,261,b_customer_tel||,||';

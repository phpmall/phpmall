...
use App\Entities\CouponCategoryEntity;
...
class CouponCategoryRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 添加
     */
    public function saveEntity(CouponCategoryEntity $entity): int
    {
     ...
     * 按照ID查询返回对象
     */
    public function findOneById(int $id): ?CouponCategoryEntity
    {
        ...
        $entity = new CouponCategoryEntity();
        $entity->setData($data);
     ...
     * 按照条件查询返回对象
     */
    public function findOne(array $condition = []): ?CouponCategoryEntity
    {

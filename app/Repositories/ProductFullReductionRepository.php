...
use App\Models\Entity\ProductFullReductionEntity;
use App\Models\ProductFullReduction;
...
class ProductFullReductionRepository extends CurdRepository implements RepositoryInterface
{
     ...
     * 定义数据数据模型类
     */
    public function model(): ProductFullReduction
    {
        return new ProductFullReduction();
    }
}

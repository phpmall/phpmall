...
#[OA\Schema(schema: 'ProductSkuQueryResponse')]
class ProductSkuQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ProductSkuResponse::class))]
    private array $data;

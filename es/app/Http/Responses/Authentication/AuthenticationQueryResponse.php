...
#[OA\Schema(schema: 'AuthenticationQueryResponse')]
class AuthenticationQueryResponse
{
    use ArrayHelper;
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AuthenticationResponse::class))]
    private array $data;

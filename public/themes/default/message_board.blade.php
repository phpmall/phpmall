...
<div class="block clearfix">
    ...
    <!--right start-->
    <div class="AreaR">
        @include('web::library/message_list')
            ...
            <div class="box_1">
                ...
                <div class="boxCenterList">
                    <form action="message.php" method="post" name="formMsg" onSubmit="return submitMsgBoard(this)">
                        <table width="100%" border="0" cellpadding="3">
                            <tr>
                                ...
                                <td>
                                    @if($smarty['session']['user_name'])
                                        <font class="f4_b">{{ $username }}</font><label for="anonymous"
                                                                                        style="margin-left:8px;"><input
                                                type="checkbox" name="anonymous" value="1"
                                                id="anonymous"/>{{ $lang['message_anonymous'] }}</label>
                                    @else
                                        {{ $lang['anonymous'] }}
                                    @endif
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input name="user_email" type="text" class="inputBg" size="20"
                                           value="{{ $smarty['session']['email'] }}"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="msg_content" cols="50" rows="4" wrap="virtual"
                                              style="border:1px solid #ccc;"></textarea></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                    ...
                    <script type="text/javascript">
                        @foreach($lang['message_board_js'] as $item => $key)
                        var {{ $key }} = "{{ $item }}";

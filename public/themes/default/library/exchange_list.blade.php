            ...
            @if($pager['display'] == 'list')
                <div class="goodsList">
                    @foreach($goods_list as $goods)
                        <ul class="clearfix bgcolor"'.($loop->goods_list.index mod 2 == 0 ? 'id=""' : 'id="bgcolor"').'>
                        ...
                        <li>
                            {{ $lang['exchange_integral'] }}<font
                                class="shop_s">{{ $goods['exchange_integral'] }}</font>
                        </li>
                        </ul>
                    @endforeach
                </div>
                        ...
                        @foreach($goods_list as $goods)
                            @if($goods['goods_id'])
                                <div class="goodsItem">
                                    ...
                                    {{ $lang['exchange_integral'] }}<font
                                        class="shop_s">{{ $goods['exchange_integral'] }}</font><br/>
                                </div>
                            @endif
                        @endforeach
                    </div>
